...
class ModulesList
{
    ...
    public function __construct(string $repositoryPath, array $blackList = [])
    {
        $this->repositoryPath = $repositoryPath ?? $_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR .
    ...
    {
        $moduleDirs = array_diff(scandir($this->repositoryPath), array('..', '.'));
    ...
    {
        $pathToModule = $this->repositoryPath . DIRECTORY_SEPARATOR . $moduleName;
